...
videoComponent.forEach(component => {
    playBtns.forEach(btn => {
        if (btn.parentNode.parentNode === component) {
            ...
            const normalscreenIcon = component.querySelector(".normalscreen-icon");
            const durationContainer = component.querySelector(".audio-duration");
            const currentTimeContainer = component.querySelector(".audio-progress");
            ...
            const controlFullscreen = () => {
                if (video.volume > 0) {
                    video.volume = 0;
                    fullscreenIcon.classList.add("toggle-screen");
                    normalscreenIcon.classList.add("toggle-screen");
                } else {
                    video.volume = 1;
                    fullscreenIcon.classList.remove("toggle-screen");
                    normalscreenIcon.classList.remove("toggle-screen");
                };
            };
